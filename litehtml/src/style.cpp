	...
	void 	style::parse_border( const xstringpart& value, const tchar_t* baseurl, bool important, int borders )
	{
		...
		if( n == 1 ) {
			...
			if( parse_border_style( parts[0], &val ) ) {
				if( borders & 1 )	{
					add_prop( atom_border_left_style, 	val, baseurl, important );
				}

				if( borders & 2 )	{
					add_prop( atom_border_right_style, 	val, baseurl, important );
				}

				if( borders & 4 )	{
					add_prop( atom_border_top_style, 	val, baseurl, important );
				}

				if( borders & 8 )	{
					add_prop( atom_border_bottom_style, val, baseurl, important );
				}
			...
			if( parse_border_style( parts[0], &val1 ) &&
				...
				if( borders & 1 )	{
					add_prop( atom_border_left_style, 	val1, baseurl, important );
				}

				if( borders & 2 )	{
					add_prop( atom_border_right_style, 	val1, baseurl, important );
				}

				if( borders & 4 )	{
					add_prop( atom_border_top_style, 	val1, baseurl, important );
				}

				if( borders & 8 )	{
					add_prop( atom_border_bottom_style, val1, baseurl, important );
				}

				if( borders & 1 )	{
					add_prop( atom_border_left_color, 	val2, baseurl, important );
				}

				if( borders & 2 )	{
					add_prop( atom_border_right_color, 	val2, baseurl, important );
				}

				if( borders & 4 )	{
					add_prop( atom_border_top_color, 	val2, baseurl, important );
				}

				if( borders & 8 )	{
					add_prop( atom_border_bottom_color, val2, baseurl, important );
				}
			...
			if( parse_length( parts[0], &val1 ) &&
				...
				if( borders & 1 )	{
					add_prop( atom_border_left_width, 	val1, baseurl, important );
				}

				if( borders & 2 )	{
					add_prop( atom_border_right_width, 	val1, baseurl, important );
				}

				if( borders & 4 )	{
					add_prop( atom_border_top_width, 	val1, baseurl, important );
				}

				if( borders & 8 )	{
					add_prop( atom_border_bottom_width, val1, baseurl, important );
				}

				if( borders & 1 )	{
					add_prop( atom_border_left_style, 	val2, baseurl, important );
				}

				if( borders & 2 )	{
					add_prop( atom_border_right_style, 	val2, baseurl, important );
				}

				if( borders & 4 )	{
					add_prop( atom_border_top_style, 	val2, baseurl, important );
				}

				if( borders & 8 )	{
					add_prop( atom_border_bottom_style, val2, baseurl, important );
				}
			...
			if( parse_length( parts[0], &val1 ) &&
				...
				if( borders & 1 )	{
					add_prop( atom_border_left_color, 	val3, baseurl, important );
				}

				if( borders & 2 )	{
					add_prop( atom_border_right_color, 	val3, baseurl, important );
				}

				if( borders & 4 )	{
					add_prop( atom_border_top_color, 	val3, baseurl, important );
				}

				if( borders & 8 )	{
					add_prop( atom_border_bottom_color, val3, baseurl, important );
				}
