	...
	*/
	...
	element* document::create_element( const tchar_t* _tag_name, const attr_map& attributes )
	{
		...
		if( !newTag ) {
			...
			else if( tag_name == atom_p )		{
				newTag = new el_para( this_doc );
			}
			else if( tag_name == atom_img )	{
				newTag = new el_image( this_doc );
			}
			else if( tag_name == atom_table )	{
				newTag = new el_table( this_doc );
			}
			else if( tag_name == atom_td || tag_name == atom_th ) {
				newTag = new el_td( this_doc );
			}
			else if( tag_name == atom_link )	{
				newTag = new el_link( this_doc );
			}
			else if( tag_name == atom_title )	{
				newTag = new el_title( this_doc );
			}
			else if( tag_name == atom_a )		{
				newTag = new el_anchor( this_doc );
			}
			else if( tag_name == atom_tr )		{
				newTag = new el_tr( this_doc );
			}
			else if( tag_name == atom_style )	{
				newTag = new el_style( this_doc );
			}
			else if( tag_name == atom_base )	{
				newTag = new el_base( this_doc );
			}
			else if( tag_name == atom_body )	{
				newTag = new el_body( this_doc );
			}
			else if( tag_name == atom_div )		{
				newTag = new el_div( this_doc );
			}
			else if( tag_name == atom_script )	{
				newTag = new el_script( this_doc );
			}
			else if( tag_name == atom_font )	{
	...
	void document::fix_flex_layouts()
	{
		size_t i = 0;
