...
litehtml::web_color litehtml::element::get_color( atom prop_name, bool inherited, const litehtml::web_color& def_color )
{
...
litehtml::atom litehtml::element::get_tagName() const						LITEHTML_RETURN_FUNC(atom_null)
void litehtml::element::set_tagName( atom /*const tchar_t* */ tag )							LITEHTML_EMPTY_FUNC
void litehtml::element::set_data( const tchar_t* data )								LITEHTML_EMPTY_FUNC
void litehtml::element::set_attr( atom name, const tchar_t* val )			LITEHTML_EMPTY_FUNC
...
const litehtml::tchar_t* litehtml::element::get_attr( atom name, const tchar_t* def /*= 0*/ )	LITEHTML_RETURN_FUNC(def)
...
const litehtml::tchar_t* litehtml::element::get_style_property( atom name, bool inherited, const tchar_t* def /*= 0*/ )	LITEHTML_RETURN_FUNC(0)
